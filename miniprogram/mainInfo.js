...
var e = {
    cats: {
        household: {
          name:  "湿垃圾",
          intro: "是指易腐垃圾，指食材废料、剩菜剩饭、过期食品、瓜皮果核、花卉绿植、中药药渣等易腐的生物质生活废弃物。",
          requirements: ["有包装物的湿垃圾应将包装物取出后分类投放，包装物请投放到对应的可回收物容器或干垃圾容器","盛放湿垃圾的容器，如塑料袋等，在投放时应予去除","投放前尽量沥干水分,纯流质湿垃圾，应直接倒入到下水口"],
          color: {
              r: 149,
              g: 108,
              b: 88
        ...
        residual: {
          ...
          requirements: ["尽量沥干水分，投入到干垃圾容器内", "难以辨识类别的生活垃圾投入干垃圾容器内"],
          color: {
              r: 45,
              g: 41,
              b: 38
        ...
        recyclable: {
          ...
          requirements: ["轻投轻放清洁干燥，避免污染", "废纸应尽量保持平整", "立体包装请清空内容物，清洁后压扁投放", "有尖锐边角的，应包裹后投放"],
          color: {
              r: 0,
              g: 60,
              b: 113
        ...
        hazardous: {
          ...
          requirements: ["充电电池、纽扣电池、蓄电池投放时请注意轻放", "油漆桶、杀虫剂如有残留请密闭后投放", "废灯管等易破损的垃圾应连带包装或包裹后轻轻投放", "废药品及其包装连带包装一并投放","在公共场所产生有害垃圾且未发现对应收集容器时，应携带至有害垃圾投放点妥善投放"],
          color: {
              r: 249,
              g: 66,
              b: 58
